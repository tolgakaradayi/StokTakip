namespace Proje_BilisimERP.Unvan
{
  partial class frmUnvanListe
  {
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmUnvanListe));
      ...
      this.colUnvanID = new DevExpress.XtraGrid.Columns.GridColumn();
      ...
      this.Name = "frmUnvanListe";
      this.Text = "Unvan Liste";
      this.Load += new System.EventHandler(this.frmUnvanListe_Load);
    ...
    private DevExpress.XtraGrid.Columns.GridColumn colUnvanID;
