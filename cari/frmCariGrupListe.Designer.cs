...
{
  partial class frmCariGrupListe
  {
    /// <summary>
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCariGrupListe));
      ...
      this.colCariGrupID = new DevExpress.XtraGrid.Columns.GridColumn();
      ...
      // colCariGrupID
      // 
      this.colCariGrupID.Caption = "CariGrup ID";
      this.colCariGrupID.FieldName = "CariGrupID";
      this.colCariGrupID.Name = "colCariGrupID";
      this.colCariGrupID.Visible = true;
      this.colCariGrupID.VisibleIndex = 0;
      this.colCariGrupID.Width = 155;
      // 
      // colCariGrupTanim
      // 
      this.colCariGrupTanim.Caption = "CariGrup Tanım";
      ...
      this.colCariGrupTanim.VisibleIndex = 1;
      this.colCariGrupTanim.Width = 246;
      // 
      // frmCariGrupListe
      // 
      ...
      this.Name = "frmCariGrupListe";
      this.Text = "CariGrup Liste";
      this.Load += new System.EventHandler(this.frmCariGrupListe_Load);
    ...
    private DevExpress.XtraGrid.Columns.GridColumn colCariGrupID;
